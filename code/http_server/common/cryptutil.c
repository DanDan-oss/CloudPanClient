...
/* -------------------------------------------*/
/**
 * @brief  加密小于4k的数据（encrypt：加密）
 *
 * @param pInData           密文数据
 * @param nInDataLen        密文数据长度
 * @param pOutData          解密后的数据
 * @param pOutDataLen       解密数据的长度
 *
 * @returns
 *      
 */
/* -------------------------------------------*/
int desEncryptText(unsigned char *pInData, int nInDataLen, unsigned char *pOutData, int *pOutDataLen)
{
    int				rv;
 ...
 */
/* -------------------------------------------*/
int desEncryptTextRaw(unsigned char *pInData, int nInDataLen, unsigned char *pOutData, int *pOutDataLen)
{
    int				rv;
//  unsigned char	*padDate = NULL;
//  unsigned int	padDateLen = 0;
 ...
 */
/* -------------------------------------------*/
int desDecryptText(unsigned char *pInData, int nInDataLen, unsigned char *pOutData, int *pOutDataLen)
{
    int				rv;
    char			padChar;
 ...
 */
/* -------------------------------------------*/
int desDecryptTextRaw(unsigned char *pInData, int nInDataLen, unsigned char *pOutData, int *pOutDataLen)
{
    int				rv;
    //char			padChar;
    //unsigned char 	*tmpPlain = NULL;
...
/*********************************************************
   data type definition for base64;
**********************************************************/
